      ...
      <div className="space-y-6 bg-white">
        ...
        <div className="items-center w-full p-4 space-y-4 text-gray-500 md:inline-flex md:space-y-0 flex gap-3">
          ...
          <div className="text-center ">
            <button
              type="button"
              className="py-2 px-4  bg-black hover:bg-yellow-400  hover:text-black focus:ring-offset-pink-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
            >
              📩 OTP
            </button>
          </div>
